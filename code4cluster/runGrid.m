...
load_mat = '/home/grad/rachel/Documents/MATLAB/MCA/ghent-multiplicative.mat';%'/home/grad/rachel/Documents/MATLAB/MCA/ghent.mat';
...
for job_id = 1:NumGrid
    ...
    %prepare the script    
    script_text = [' computeBayesianSeparation_cluster ' ...
        num2str(NumGrid) ' ' ...
        result_path ' ' ...
        result_path ' ' ...
        load_mat ' ' ...
